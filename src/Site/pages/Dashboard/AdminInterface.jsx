...
import css from './AdminInterface.module.css'

const AdminInterface = ({ children }) => {
            ...
            <div className={css.leftPanel}>
                ...
                <menu>
                    <Link to="/dashboard/produits">
                        <li className={`${css.menuItem} ${css.__products}`}>
                    ...
                    <Link to="/dashboard/collections">
                        <li className={`${css.menuItem} ${css.__collections}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                    ...
                    <Link to="/dashboard/categories">
                        <li className={`${css.menuItem} ${css.__categories}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                    ...
                    <Link to="/dashboard/commandes">
                        <li className={`${css.menuItem} ${css.__commandes}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
